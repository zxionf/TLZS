package com.zyx.kga.common.crash;
...
import com.zyx.kga.ui.activity.Kp;
...
public final class CrashHandler {
    ...
    public static final class CrashActiviy extends Activity implements MenuItem.OnMenuItemClickListener {
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            menu.add(0, 43, 0, "重启").setOnMenuItemClickListener(this)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
            menu.add(0, 55, 0, "退出").setOnMenuItemClickListener(this)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
            return true;
        }
